...
# -----------------------------
# Load pre-trained weights (File Check Added)
MODEL_PATH = "best_model.pth"
if os.path.exists(MODEL_PATH):
    try:
        model.load_state_dict(torch.load(MODEL_PATH, map_location=device), strict=False)
    except RuntimeError as e:
        st.warning("Model loaded partially due to layer mismatches.")
else:
    st.error("Model file not found! Train and save 'best_model.pth' first.")
...
if st.button("Generate Poetry"):
    if os.path.exists(MODEL_PATH):
        ...
        st.error("Model not available! Train and save 'best_model.pth' first.")
